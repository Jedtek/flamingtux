...
class PreferencesWin {
	...
	private:
		...
		void onUserDirectoryFCBSelectionChanged();
		void onLoggingDirectoryFCBSelectionChanged();
		...
		void onEnableEventSoundsCBToggled();
		void onESReceivedMessagesCBToggled();
		void onESBuddyStatusCBToggled();
		void onESCommandEntryChanged();
		void onEntryChanged();
		...
		Gtk::FileChooserButton *puserdirectoryfcb_;
		Gtk::FileChooserButton *ploggingdirectoryfcb_;
		...
		Gtk::CheckButton *penableeventsoundscb_;
		Gtk::CheckButton *pesreceivedmessagescb_;
		Gtk::CheckButton *pesbuddystatuscb_;
		Gtk::Entry *pescommandentry_;
};
